...
# These JSON schemas are made according to the specifications from
# http://json-schema.org, Draft 4.
# Check http://spacetelescope.github.io/understanding-json-schema/ for a good
# reference on JSON schema specifications.
...
SCHEMA_INJSON = {
    ...
    "definitions": { # Defines some types of objects used in the schema
        ...
        "compilationDescr": {"type": "object",
            ...
            "properties": {
                "language": {"type": "string", "description": "Language of the program."},
        ...
        "executionParams": {"type": "object",
            ...
            "properties": {
                ...
                "getFiles": {"type": "array", "description": "Files to capture in the report.", "items": {"type": "string"}}},
    ...
    "properties": { # Fields of the main JSON
        ...
        "generations": {"type": "array",
            ...
            "items": {"type": "object",
                ...
                "properties": {
                    ...
                    "idGenerator": {"type": "string", "description": "Name of the generator."},
                    "idOutputGenerator": {"type": "string", "description": "Name of the output generator, if applicable."},
                    ...
                    "testCases": {"type": "array", "description": "List of specific test cases to generate.",
                        "items": {"type": "object", "properties": {
                            "name": {"type": "string", "description": "Filename of the test to generate."},
                            "params": {"type": "array", "description": "Command-line arguments for the generator.", "items": {"type": "string"}}},
        ...
        "executions": {"type": "array",
            ...
            "items": {"type": "object",
                ...
                "properties": {
                    ...
                    "filterTests": {"type": "array", "description": "List of globs filtering tests to input to the solution.", "items": {"type": "string"}},
                    "runExecution": {"$ref": "#/definitions/executionParams"}},
